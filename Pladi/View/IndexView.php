			...
			<div class="grupo">
				...
				<?php for ($i = 0 ; $i < count($usuarios) && $i < 20 ; $i ++ ): ?>
					...
					<div class="caja centrar-contenido base-50 movil-1-3 tablet-1-6 web-1-8">
						<img id="<?=$usuarios[$i]->getId();?>" class="usuario__imagen" src="<?= $usuarios[$i]->getPerfilUsuario()->getFoto() != NULL ? $usuarios[$i]->getPerfilUsuario()->getFoto() : '/img/users/template.png' ?>" alt="user <?=$usuarios[$i]->getNombre()?>">
